...
// ドラッグ可能な要素 (input)
['assumption', 'derive-basis', 'relation-side-angle', 'numbering', 'conclusion-basis', 'conclusion'].forEach(el => {
  new Sortable(get(el), {
    group: {
      name: 'shared',
      pull: 'clone',
...
function showScreen(id) {
  ['assumption', 'derive-basis', 'relation-side-angle', 'numbering', 'conclusion-basis', 'conclusion'].forEach(area => {
